#lang plai
; F1WAE with deferred subsitution
...
; (parse '{f 1})
; (parse-fd '{deffun {f y} {+ y x}})
(test/exn (interp (app 'f (num 1)) (list (fundef 'f 'y (add (id 'y) (id 'x)))) (mtSub)) "free identifier")

; (parse '{with {x 10} {f 1}})
; (parse-fd '{deffun {f y} {+ y x}})
(test/exn (interp (with 'x (num 10) (app 'f (num 1))) (list (fundef 'f 'y (add (id 'y) (id 'x)))) (mtSub)) "free identifier")